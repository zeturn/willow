...
<div class="container mx-auto p-4 dark:bg-gray-900">
    <div class="flex flex-wrap -mx-4">
        <div class="w-full lg:w-3/4 px-4">
            ...
            <div class="bg-white rounded-lg p-6 dark:border-gray-700 dark:bg-gray-800 mb-4">
                <h2 class="text-2xl mb-6 font-bold text-gray-800 dark:text-white">{{__('basic.Branch')}}{{__('basic.Info')}}</h2>
                ...
                <div class="mb-6">
                    ...
                    {{__('basic.Version')}}{{__('basic.Number')}}
                    </label>
 ...
 mb-4">{{__('basic.Other')}}{{__('basic.Info')}}</h3>
                <!-- 在这里添加额外的信息或组件 -->
            </div>
