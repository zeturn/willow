    ...
    <div class="flex flex-wrap -mx-4"> <!-- 用于包含主列和侧边栏的容器 -->
        <div class="w-full lg:w-3/4 px-4"> <!-- 主列 -->
            ...
            <div class="bg-white rounded-lg p-6 dark:border-gray-700 dark:bg-gray-800 mb-4">
                <h2 class="text-2xl mb-6 font-bold text-gray-800 dark:text-white">{{__('basic.Entry')}}{{__('basic.Details')}}</h2>
                ...
                <div class="mb-6">
                    <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" for="demo_branch">
                        {{__('basic.Demo')}}{{__('basic.Branch')}} ID
                    </label>
                ...
                <div class="mb-6">
                    ...
                    {{__('basic.Branch')}}{{__('basic.Number')}}
                    </label>
        ...
        <div class="w-full lg:w-1/4 px-4 mt-6 lg:mt-0">
            <!-- 可以在这里添加更多信息或功能的卡片 -->
            <div class="bg-white rounded-lg p-6 dark:border-gray-700 dark:bg-gray-800 mb-4">
                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4">{{__('basic.Other')}}{{__('basic.Info')}}</h3>
                <!-- 在这里添加额外的信息或组件 -->
                <!-- 访问量 字段 -->
                <div class="mb-6">
                    <label class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2" for="branch_count">
            ...
            <div class="bg-white rounded-lg p-6 dark:border-gray-700 dark:bg-gray-800">
                <h3 class="text-xl font-bold text-gray-800 dark:text-white mb-4">{{__('basic.Related')}}{{__('basic.Link')}}</h3>
                <p class="text-gray-700 dark:text-gray-400 leading-tight">-</p>
                <!-- 在这里添加链接或其他内容 -->
            </div>
        </div>
