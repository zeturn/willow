    ...
    <div x-data="{
        ...
        <div class="flex items-center justify-between w-full h-full px-3 mx-auto max-w-7xl z-50">
            <a href="#" class="flex flex-col w-full h-full text-xs leading-6 text-black duration-150 ease-out sm:flex-row sm:items-center opacity-80 hover:opacity-100">
                ...
                <span class="block pt-1 pb-2 leading-none sm:inline sm:pt-0 sm:pb-0">本网站上的图文内容来源于基于互联网上内容的机器生成，不代表任何人的观点和立场。The graphic and text content on this website is generated by machines based on content on the Internet and does not represent anyone's views and positions.</span>
            </a>
