        ...
        <nav class="flex justify-between">
            <ol class="inline-flex items-center mb-3 space-x-3 text-sm text-neutral-500 [&_.active-breadcrumb]:text-neutral-500/80 sm:mb-0">
                ...
                <li><div 
                    ...
                    <a x-ref="content" href="{{ route('wall.show', $topic->wall) }}" class="inline-flex items-center py-1 font-normal hover:text-neutral-900 focus:outline-none">{{ $topic->wall->name }}</a>
                </div></li>
                <span class="mx-2 text-gray-400">/</span>
                <li><div 
                    x-data="{
                    ...
                    <a x-ref="content" class="inline-flex items-center py-1 font-normal hover:text-neutral-900 focus:outline-none">{{ $topic->name }}</a>
                </div></li>
            </ol>
        </nav>
