...
<div class="container mx-auto p-4 dark:bg-gray-900 max-w-7xl">
    <div class="flex flex-wrap -mx-4">
        ...
        <div class="w-full lg:w-3/4 px-4">
            <div class="bg-white rounded-lg p-6 dark:border-gray-700 dark:bg-gray-800 mb-4 shadow overflow-hidden sm:rounded-lg">
                <h1 class="text-2xl font-semibold text-gray-900">{{ __('Edge Details') }}</h1>
                <div class="mt-4">
