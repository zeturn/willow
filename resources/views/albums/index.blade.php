    ...
    <div class="w-full lg:w-3/4 px-4">
            ...
            <div class="bg-white rounded-lg p-6 dark:border-gray-700 dark:bg-gray-800 mb-4">
                ...
                <div class="flex justify-start space-x-2">
                    ...
                    <form action="{{ route('albums.delete', $album->id) }}" method="POST" class="mt-2">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-color-danger-500 hover:bg-color-danger-600 text-white" onclick="return confirm('Are you sure you want to delete this album?');">
