<div class="flex justify-center">
    <form wire:submit.prevent="updateProfile" class="md:w-3/4 bg-white p-6">
        <div class="form-group p-1">
            <label for="real_name" class="text-sm font-medium text-gray-700">真实姓名:</label>
        ...
        <div class="form-group p-1">
            <label for="country" class="text-sm font-medium text-gray-700">国家:</label>
        ...
        <div class="form-group p-1">
            <label for="language" class="text-sm font-medium text-gray-700">语言:</label>
        ...
        <div class="form-group p-1">
            <label for="birthdate" class="text-sm font-medium text-gray-700">生日:</label>
        ...
        <div class="form-group p-1">
            <label for="signature" class="text-sm font-medium text-gray-700">签名:</label>
        ...
        <div class="form-group p-1">
            <label for="links" class="text-sm font-medium text-gray-700">链接:</label>
        ...
        <div class="form-group">
            <x-button type="submit" class="btn btn-primary mt-4">保存</x-button>
