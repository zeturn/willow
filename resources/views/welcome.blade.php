        ...
        <div class="w-full px-4">
            ...
            <section class="flex flex-wrap items-center py-10 px-6">
                <div class="w-full lg:w-1/2">
                    ...
                    @guest
                    <a href="{{ route('register') }}" class="bg-gradient-to-r from-green-400 to-blue-500 hover:from-green-500 hover:to-blue-600 text-white font-bold py-3 px-6 rounded-lg transition duration-300 m-6">{{ __('basic.Sign up') }}</a>
                    @endguest
